...
// document.getElementById('sidebar').on('hide.bs.collapse' , function(e) {
//     if(e.target == this) {
//         document.getElementById('main').removeClass('col-md-10');
//     }
// })
// document.getElementById('sidebar').on('show.bs.collapse' , function(e) {
//     if(e.target == this) {
//         document.getElementById('main').addClass('col-md-10');
//     }
// });
